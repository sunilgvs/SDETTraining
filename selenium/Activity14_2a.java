...
public class Activity14_2a {
    ...
    public void writeExcel(String filePath) throws IOException {
        ...
        String[] row1 = {"1", "Sunil", "G", "satshah@example.com", "4537829158"};
        String[] row2 = {"2", "Ramya", "G", "avinashK@example.com", "4892184058"};
        String[] row3 = {"3", "Kaushal", "G", "lahri.rath@example.com", "4528727830"};
