...
public class CreateJobsVacancy {
    ...
    public void AddVacancies() {
    	...
    	driver.findElement(By.id("addJobVacancy_name")).sendKeys("Vacancy_Project_CRM");



    	driver.findElement(By.id("addJobVacancy_hiringManager")).sendKeys("IBM Manager");
